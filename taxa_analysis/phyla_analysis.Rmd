...
1. Ordination and *adonis* phyla data 
2. Ordination and *adonis* class data
3. taxa analysis heatmap @ class level 
4. taxa analysis heatmap --> tubermass gradient
5. taxa analysis broadscale vs fine scale diversity?
